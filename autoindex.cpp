...
{
private:
	 const char *_html_start = "<!doctype html><html><header><style>div {display: block;text-align: center;} a {vertical-align:middle;} img {vertical-align: bottom;width: 20px;}</style></header><body>";
